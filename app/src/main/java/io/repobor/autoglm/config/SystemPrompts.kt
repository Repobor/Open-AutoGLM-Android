...
/**
 * System prompts for the AI agent in both Chinese and English.
 * Ported from Open-AutoGLM Python project.
 */
object SystemPrompts {

    /**
     * Get the current date formatted in Chinese style.
     * @return Formatted date string like "2025年12月14日 星期六"
     */
    private fun getFormattedDateChinese(): String {
        ...
        return dateFormat.format(today) + " " + weekday
    }

    /**
     * Get the current date formatted in English style.
     * @return Formatted date string like "2025-12-14, Saturday"
     */
     ...
     * Provides comprehensive instructions for the AI agent in Chinese.
     */
    val CHINESE_PROMPT: String
        get() = """今天的日期是: ${getFormattedDateChinese()}
...
"""
     ...
     * Provides comprehensive instructions for the AI agent in English.
     */
    val ENGLISH_PROMPT: String
        get() = """The current date: ${getFormattedDateEnglish()}
# Setup
...
"""
    ...
    /**
     * Get system prompt by language preference.
     * @param language "zh" for Chinese, "en" for English
     * @return System prompt in specified language
     */
    fun getPromptByLanguage(language: String): String {
        return when (language.lowercase()) {
            "zh", "chinese", "中文" -> CHINESE_PROMPT
            "en", "english" -> ENGLISH_PROMPT
            else -> ENGLISH_PROMPT // Default to English
        }
    }
}
